...
\usetikzlibrary{arrows.meta, positioning, shapes.geometric, shapes.misc} % Required for Ch3 architecture diagrams
...
\usepackage{makecell}
\usepackage{float} % Required for [H] figure placement specifier

% Fix section header alignment - prevent numbers from hanging into margin
\usepackage{titlesec}
\titleformat{\section}
...
\thesistitle{{[}TÍTULO DA DISSERTAÇÃO{]}} % Your thesis title, this is used in the title, print it elsewhere with \ttitle

\thesissubtitle{{[}Sub-Título (se exisitir){]}} % Your thesis title, this is used in the title, print it elsewhere with \tsubtitle

\author{{[}Nome Completo do(a) Candidato(a){]}} % Your name, this is used in the title page, print it elsewhere with \authorname
...
\supervisor{{[}Nome do Orientador{]}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\committeepresident{{[}Nome do Presidente, Categoria, Escola{]}} % Name of the president of the evaluation committee, print it elsewhere with \presidentname

\committeemembers{{[}Nome do Vogal1, Categoria, Escola{]}\\{[}Nome do Vogal2, Categoria, Escola{]} (até 4 vogais)\\} % Name of the evaluation committee members (up to four), print it elsewhere with \committee
